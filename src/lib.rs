...
const ERR_MSG: &str =
  "Derive(GetFields) only applicable to named structs";
...
/// the `get_fields` attribute is used wrongfully, deriving
...
pub fn derive_get_fields(
  ...
  let result = quote! {
    impl #impl_generics #name #type_generics #where_clause {
      ...
      #vis const get_fields: &'static [&'static str] =
        &[#field_names];
    }
  };
